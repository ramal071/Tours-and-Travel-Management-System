...
if(isset($_POST['submit'])) {
    if(empty($_POST['town_id']) OR empty($_POST['price'])){
    ...
    $searchs = $conn->query("SELECT * FROM cities WHERE town_id = $town_id AND price < $price");
    $searchs->execute();
            ...
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  ...
                  <p>Limited Price: Rs.<?php echo $search->price; ?> Per Person</p>
                  <?php if(isset($_SESSION['username'])) :?>
                  <div class="main-button">
                    <a href="reservation.php?=<?php echo $search->id; ?>">Make a Reservation</a>
                  </div>
                  <?php else : ?>
